...
export default function Dashboard() {
  ...
  // Logika Perhitungan (Sesuai kolom CSV: JENIS KELAMIN & STATUS SISWA)
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-8">
          ...
          <div className="bg-white rounded-[2rem] shadow-sm border border-slate-100 overflow-hidden">
            <div className="p-6 border-b border-slate-50 font-black text-slate-800">Daftar Siswa</div>
            <div className="overflow-x-auto">
              <table className="w-full text-left border-collapse">
                ...
                <tbody className="text-sm">
                  {loading ? (
                    <tr>
                      {/* PERBAIKAN: colSpan={6} (menggunakan kurung kurawal, bukan tanda kutip) */}
                      <td colSpan={6} className="p-8 text-center text-slate-400 italic">
                        Memuat data kesiswaan...
                      </td>
                    </tr>
                  ) : dataSiswa.map((s, i) => (
